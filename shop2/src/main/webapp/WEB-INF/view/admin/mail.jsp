...
enctype="multipart/form-data" onsubmit="return idinputchk(this)">
   ...
   본인네이버비밀번호 : <input type="password" name="naverpw" class="w3-input">
<table class="w3-table">
 <tr><td>보내는사람</td><td>${loginUser.email}</td></tr>
 <tr><td>받는사람</td>
 <td><input type="text" name="recipient" size="100" value=
'<c:forEach items="${list}" var="user">
${user.username} &lt;${user.email}&gt;,</c:forEach>' class="w3-input"></td></tr>
...
<tr><td colspan="2"><textarea name="contents" cols="120" rows="10" class="w3-input"></textarea>
