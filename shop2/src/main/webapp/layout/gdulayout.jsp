    ...
    <p>Powered by <a href="https://www.w3schools.com/w3css/default.asp" target="_blank">w3.css</a></p>
   	...
   	<span id="si">
   		<select name="si" onchange="getText('si')">
   			<option value="">시,도를 선택 하세요.</option>
   		</select>
   	</span>
   	<span id="gu">
   		<select name="gu" onchange="getText('gu')">
   			<option value="">구,군을 선택 하세요.</option>
   		</select>
   	</span>
   	<span id="dong">
   		<select name="dong">
   			<option value="">동,리를 선택 하세요.</option>
   		</select>
   	</span>
   	</div> 
  </footer>
...
<script type="text/javascript">
// 시군구 ajax 스크립트
	$(function(){ // 레이아웃에서 바로 동작
		getSido() // sido.txt 정보 조회
	...
	function getSido2() { // 서버에서 문자열로 전달 받음
		$.ajax({
